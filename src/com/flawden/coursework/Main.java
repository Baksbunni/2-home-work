...
//        employees[0] = new Employee("Николай", "Дмитриевич", "Малышев", 1, 330000);
//        employees[1] = new Employee("Александр", "Владимирович", "Албанов", 2, 25000);
//        employees[2] = new Employee("Станислав", "Дмитриевич", "Журавлев", 2, 300000);
//        employees[3] = new Employee("Анна", "Степановна", "Гусева", 4, 100000);
//        employees[4] = new Employee("Елена", "Николаевна", "Щибякина", 5, 35000);
//        employees[5] = new Employee("Олег", "Александрович", "Жлобов", 3, 150000);
//        employees[6] = new Employee("Валерий", "Валентинович", "Храбров", 3, 122000);
//        employees[7] = new Employee("Петр", "Владимирович", "Пивоваров", 2, 130000);
//        employees[8] = new Employee("Олег", "Ярославович", "Солнцев", 1, 250000);
//        employees[9] = new Employee("Вячеслав", "Дмитриевич", "Мартынов", 1, 150000);
//    }
